        ...
        <div class="content-container" ref="content">
            ...
            <template v-if="inputInfo.password != null && inputInfo.password != md5(inputInfo.inputPassword)">
                ...
                <div class="cursor-container">[root@{{ menuInfo.name }} ~]# {{ inputInfo.showPassword }}
                    <span v-show="inputInfo.isFocus" class="cursor">
...
<script setup>
    ...
    function onkeydownEnter(){
        utils.send({},inputInfo,menuInfo,commandData);
        returnBottom();
    }
    ...
    onMounted(()=>{
        ...
        function eventRegister(){
            utils.register(mainDom.value,textInput.value,titlePanel.value,null,inputInfo,menuInfo);
        }
        eventRegister();
    })
